...
import { uplodaVideoAPI } from '../services/allAPI'
        ...
        <>
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <Button onClick={handleUplodViedo} className='btn btn-info'>Upload</Button>
                </Modal.Footer>
            </Modal>
        </>
    )
